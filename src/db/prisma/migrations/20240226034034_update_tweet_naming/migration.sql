/*
  ...
  - You are about to drop the column `twitId` on the `Bookmark` table. All the data in the column will be lost.
...
-- DropForeignKey
ALTER TABLE "Twit" DROP CONSTRAINT "Twit_authorId_fkey";

-- DropIndex
DROP INDEX "Bookmark_userId_twitId_key";

-- AlterTable
ALTER TABLE "Bookmark" DROP COLUMN "twitId",
